  ...
  <view class="page">
    <view class="header">
      ...
      <view class="header-content">
        ...
        <text class="header-title">限高消费</text>
        <text class="header-desc">限制高消费人员查询</text>
      </view>
    </view>
    ...
    <view class="notice">
      ...
      <text class="notice-text">被限高后将无法乘坐飞机/高铁/住星级酒店</text>
    </view>
    ...
    <view v-if="searched" class="result-card">
      ...
      <view class="result-grid">
        <view class="grid-row">
          ...
          <text class="grid-value">{{ keyword || '王*强' }}</text>
        </view>
        <view class="grid-row">
          <text class="grid-label">限高状态</text>
          <text class="grid-value highlight">无记录</text>
        </view>
        <view class="grid-row">
          <text class="grid-label">执行法院</text>
          <text class="grid-value">-</text>
        </view>
        <view class="grid-row">
          <text class="grid-label">立案时间</text>
          <text class="grid-value">-</text>
        </view>
        <view class="grid-row">
          <text class="grid-label">案号</text>
          <text class="grid-value">-</text>
        </view>
        <view class="grid-row">
          <text class="grid-label">限高原因</text>
          <text class="grid-value">-</text>
        </view>
        <view class="grid-row">
