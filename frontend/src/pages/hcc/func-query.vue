...
const serviceInfoMap: Record<string, Record<string, { icon: string; bgColor: string; desc: string; price: string }>> = {
  ...
  marriage: {
    ...
    '伴侣背调': { icon: '✅', bgColor: '#E8F5E9', desc: '全面伴侣背景调查', price: '¥5.9' },
    '婚前调查': { icon: '💑', bgColor: '#FCE4EC', desc: '婚前全面背景调查', price: '¥5.9' },
  },
  risk: {
  ...
  finance: {
    ...
    '洗钱风险': { icon: '📱', bgColor: '#E3F2FD', desc: '反洗钱风险评估', price: '¥5.9' },
    '投资风险': { icon: '💰', bgColor: '#FFF3E0', desc: '投资理财风险评估', price: '¥2.9' },
    '征信修复': { icon: '✅', bgColor: '#E8F5E9', desc: '征信修复方案咨询', price: '¥5.9' },
    '风险综合评估': { icon: '🔍', bgColor: '#E0F7FA', desc: '全面风险综合评估报告', price: '¥5.9' },
  },
  car: {
