...
const serviceData: Record<string, Array<{
  ...
  marriage: [
    ...
    { name: '伴侣背调', icon: '✅', bgColor: '#E8F5E9', desc: '全面伴侣背景调查', price: '¥2.9', tag: '专业', tagBg: '#E8F0FF', tagColor: '#1A6CFF', typeCode: 'marriage' },
    { name: '婚前调查', icon: '💑', bgColor: '#FCE4EC', desc: '婚前全面背景调查', price: '¥2.9', tag: '专业', tagBg: '#E8F0FF', tagColor: '#1A6CFF', typeCode: 'marriage' },
  ],
  risk: [
  ...
  finance: [
    ...
    { name: '资产调查', icon: '📁', bgColor: '#FFF3E0', desc: '个人资产状况调查', price: '¥2.9', tag: '专业', tagBg: '#E8F0FF', tagColor: '#1A6CFF', typeCode: 'finance' },
  ...
  car: [
    ...
    { name: '二手车检测', icon: '🔧', bgColor: '#F1F8E9', desc: '二手车全面检测报告', price: '¥2.9', tag: '专业', tagBg: '#E8F0FF', tagColor: '#1A6CFF', typeCode: 'car' },
